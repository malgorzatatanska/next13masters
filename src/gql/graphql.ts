...
export const CategoryListProductItemFragmentFragmentDoc = new TypedDocumentString(`
...
}`) as unknown as TypedDocumentString<GetProductListQuery, GetProductListQueryVariables>;
